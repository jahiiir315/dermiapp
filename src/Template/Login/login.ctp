...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $this->Url->build(); ?>"><strong>Dermiapp</strong></a>
  </div>
  <!-- /.login-logo -->
  ...
  <div class="login-box-body">
    ...
    <fieldset>
        <div class="form-group has-feedback">
            <?= $this->Form->input('email', ['class'=> 'form-control', 'placeholder'=>'E-mail','label'=> false, 'required']) ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
             <?= $this->Html->link('Registrarse',['controller'=> 'users', "action"=>"add"],['class'=>'btn btn-primary btn-block btn-flat'])?>
            </div>
        </div>
    </fieldset>
    <?= $this->Form->end()?>
