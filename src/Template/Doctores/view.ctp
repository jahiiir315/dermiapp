      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($doctore->nombres) ?></dd>
            <dt scope="row"><?= __('Apellido paterno') ?></dt>
            <dd><?= h($doctore->apellido1) ?></dd>
            <dt scope="row"><?= __('Apellido materno') ?></dt>
            <dd><?= h($doctore->apellido2) ?></dd>
            <dt scope="row"><?= __('Dni') ?></dt>
            <dd><?= h($doctore->dni) ?></dd>
            <dt scope="row"><?= __('Codigomedico') ?></dt>
            <dd><?= h($doctore->codigomedico) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($doctore->id) ?></dd>
          </dl>
        </div>
      </div>
    </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
              ...
              <?php foreach ($doctore->users as $users): ?>
              <tr>
                    <td><?= h($users->id) ?></td>
