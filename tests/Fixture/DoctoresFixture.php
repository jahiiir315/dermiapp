...
class DoctoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'codigomedico' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'dni' => 'Lorem ',
                'codigomedico' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
